def TIDEFF(BLATA, BLONG, DD, MM, YYYY, hh, mm):
    ...
    E1 = (16751.04 + TT * (-41.8 - TT * 0.126)) * pow(10, -6)
    P1 = (1012395.0 + TT * (6189.03 + TT * (1.63 + TT * 0.012))) * RDNS
    ...
    TID = -6.67 * pow(10, -8) * (7.3537 * pow(10, 25) * D * D * R * D * (3.0 * CM * CM - ONE + 1.5 * R * D * CM * (5 * CM * CM - 3)) + 1.993 * pow(10, 33) * D1 * D1 * R * D1 * (3 * CS * CS - 1)) * pow(10, 3)
    TIDAL = TID * TIDAMP
    return TIDAL
